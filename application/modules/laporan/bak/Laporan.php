...
class laporan extends MX_Controller {
	...
	public function service()
	{
		...
		if ($dari != '') {
			$data['laporan_keluar'] = $this->laporan_model->get_all_service_keluar($dari,$sampai);
			$data['laporan_masuk'] = $this->laporan_model->get_all_service_masuk($dari,$sampai);
			$data['total_service'] = $this->laporan_model->get_total_service($dari,$sampai);
		}else{
			$data['laporan_keluar'] = $this->laporan_model->get_all_service_keluar();
			$data['laporan_masuk'] = $this->laporan_model->get_all_service_masuk();
			$data['total_service'] = $this->laporan_model->get_total_service();
		}
