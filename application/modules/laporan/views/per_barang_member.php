<div class="box box-danger">
	<div class="box-header with-border">
		...
		<div class="pull-right">
			...
			<a target="_blank" href="<?php echo base_url('laporan/cetak_per_barang/member/' . $dari . '/' . $sampai . '/' . $this->input->get('id_outlet')) ?>" class="btn btn-info"><i class="fa fa-print"></i> Cetak</a>
			<a href="<?php echo base_url('laporan/export_per_barang/member/'. $dari . '/' . $sampai . '/' . $this->input->get('id_outlet')) ?>" class="btn btn-success"><i class="fa fa-sign-in"></i> Export Excel</a>
			<?php else: ?>
				<a href="<?php echo base_url('laporan/cetak_per_barang/member') ?>" class="btn btn-info"><i class="fa fa-print"></i> Cetak</a>
			<a href="<?php echo base_url('laporan/export_per_barang/member') ?>" class="btn btn-success"><i class="fa fa-sign-in"></i> Export Excel</a>
			<?php endif ?>
					...
					<table class="table datatable">
						...
						<tbody>
							...
							<tr>
								...
								<td><?= number_format($row['profit_member']) ?></td>
