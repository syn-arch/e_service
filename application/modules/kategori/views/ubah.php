                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_kategori')) echo 'has-error'?>">
                          ...
                          <input readonly="" type="text" id="id_kategori" name="id_kategori" class="form-control" value="<?php echo $kategori['id_kategori'] ?>">
                          <?php echo form_error('id_kategori', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('nama_kategori')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_kategori" name="nama_kategori" class="form-control nama_kategori" placeholder="Nama kategori" value="<?php echo $kategori['nama_kategori'] ?>">
