                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_outlet')) echo 'has-error'?>">
                          ...
                          <input readonly="" type="text" id="id_outlet" name="id_outlet" class="form-control" value="<?php echo $outlet['id_outlet'] ?>">
                          <?php echo form_error('id_outlet', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('nama_outlet')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_outlet" name="nama_outlet" class="form-control nama_outlet" placeholder="Nama outlet" value="<?php echo $outlet['nama_outlet'] ?>">
                           ...
                           <div class="form-group <?php if(form_error('alamat')) echo 'has-error'?>" >
                               ...
                               <textarea name="alamat" id="alamat" cols="30" rows="5" class="form-control " placeholder="alamat"><?php echo $outlet['alamat'] ?></textarea>
                           ...
                           <div class="form-group <?php if(form_error('telepon')) echo 'has-error'?>">
                             ...
                             <input type="text" id="telepon" name="telepon" class="form-control telepon " placeholder="Telepon" value="<?php echo $outlet['telepon'] ?>">
                             <?php echo form_error('telepon', '<small style="color:red">','</small>') ?>
                           </div>
                           <div class="form-group <?php if(form_error('email')) echo 'has-error'?>">
                             <label for="email">E-mail</label>
                             <input type="text" id="email" name="email" class="form-control email " placeholder="E-mail" value="<?php echo $outlet['email'] ?>">
