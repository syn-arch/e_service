                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        <div class="form-group <?php if(form_error('id_supplier')) echo 'has-error'?>">
                          ...
                          <input readonly="" type="text" id="id_supplier" name="id_supplier" class="form-control" value="<?php echo $supplier['id_supplier'] ?>">
                          <?php echo form_error('id_supplier', '<small style="color:red">','</small>') ?>
                           ...
                           <div class="form-group <?php if(form_error('nama_supplier')) echo 'has-error'?>">
                               ...
                               <input type="text" id="nama_supplier" name="nama_supplier" class="form-control nama_supplier" placeholder="Nama supplier" value="<?php echo $supplier['nama_supplier'] ?>">
                           ...
                           <div class="form-group <?php if(form_error('alamat')) echo 'has-error'?>">
                               ...
                               <input type="text" id="alamat" name="alamat" class="form-control alamat" placeholder="Nama supplier" value="<?php echo $supplier['alamat'] ?>">
                           ...
                           <div class="form-group <?php if(form_error('telepon')) echo 'has-error'?>">
                               ...
                               <input type="text" id="telepon" name="telepon" class="form-control telepon" placeholder="Nama supplier" value="<?php echo $supplier['telepon'] ?>">
