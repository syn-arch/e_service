                   ...
                   <div class="col-md-8">
                       <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group <?php if(form_error('barcode')) echo 'has-error'?>">
                          <label for="barcode">Barode</label>
                          <input readonly="" type="text" id="barcode" name="barcode" class="form-control barcode " placeholder="Barode" value="<?php echo get_barcode_pelanggan() ?>">
