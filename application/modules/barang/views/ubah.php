    ...
    <div class="box box-danger">
      ...
      <div class="box-body">
        ...
        <div class="col-md-8">
         <form method="POST" enctype="multipart/form-data">
          <div class="form-group <?php if(form_error('id_barang')) echo 'has-error'?>">
            ...
            <input readonly="" type="text" id="id_barang" name="id_barang" class="form-control id_barang " placeholder="ID barang" value="<?php echo $barang['id_barang']?>">
          ...
          <div class="form-group <?php if(form_error('nama_barang')) echo 'has-error'?>">
            ...
            <input type="text" id="nama_barang" name="nama_barang" class="form-control nama_barang " placeholder="Nama Barang" value="<?php echo $barang['nama_barang'] ?>">
          ...
          <div class="form-group <?php if(form_error('nama_pendek')) echo 'has-error'?>">
            ...
            <input type="text" id="nama_pendek" name="nama_pendek" class="form-control nama_pendek " placeholder="Nama Pendek" value="<?php echo $barang['nama_pendek'] ?>">
       ...
       <div class="form-group <?php if(form_error('satuan')) echo 'has-error'?>">
        ...
        <input type="text" id="satuan" name="satuan" class="form-control satuan " placeholder="Satuan" value="<?php echo $barang['satuan'] ?>">
      ...
      <div class="form-group <?php if(form_error('harga_pokok')) echo 'has-error'?>">
        ...
        <input type="number" id="harga_pokok" name="harga_pokok" class="form-control harga_pokok " placeholder="Harga Pokok" value="<?php echo $barang['harga_pokok'] ?>">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group <?php if(form_error('harga_jual')) echo 'has-error'?>">
            ...
            <input type="number" id="harga_jual" name="harga_jual" class="form-control harga_jual " placeholder="Harga Jual" value="<?php echo $barang['harga_jual'] ?>">
        ...
        <div class="col-md-6">
          <div class="form-group <?php if(form_error('profit')) echo 'has-error'?>">
            ...
            <input readonly="" type="number" id="profit" name="profit" class="form-control profit " placeholder="Profit" value="<?php echo $barang['profit'] ?>">
      ...
      <div class="form-group <?php if(form_error('stok')) echo 'has-error'?>">
        ...
        <input type="text" id="stok" name="stok" class="form-control stok " placeholder="Stok" value="<?php echo $barang['stok'] ?>">
        <?php echo form_error('stok', '<small style="color:red">','</small>') ?>
      </div>
      <div class="form-group <?php if(form_error('diskon')) echo 'has-error'?>">
        <label for="diskon">Diskon</label>
        <input type="text" id="diskon" name="diskon" class="form-control diskon " placeholder="Diskon" value="<?php echo $barang['diskon'] ?>">
      ...
      <div class="form-group <?php if(form_error('barcode')) echo 'has-error'?>">
        ...
        <input type="number" id="barcode" name="barcode" class="form-control barcode " placeholder="Barcode" value="<?php echo $barang['barcode'] ?>">
        <?php echo form_error('barcode', '<small style="color:red">','</small>') ?>
      </div>
      <div class="form-group <?php if(form_error('gambar')) echo 'has-error'?>">
        <label for="gambar">Gambar</label>
        <input type="file" id="gambar" name="gambar" class="form-control gambar " placeholder="Gambar" value="<?php echo $barang['gambar'] ?>">
